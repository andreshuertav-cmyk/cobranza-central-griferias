      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        {isLoading ? (
          ...
          <>
            ...
            <div className="mt-8">
              <h2 className="text-xl font-bold text-slate-900 mb-4">Gestiones por cliente</h2>
              <ClientManagementReport logs={logs} clients={clients} documents={documents} />
            </div>

            {/* Payment Methods Report */}
            <div className="mt-8">
              <h2 className="text-xl font-bold text-slate-900 mb-4">Pagos por método</h2>
            ...
            <div className="mt-8">
              <h2 className="text-xl font-bold text-slate-900 mb-4">Promesas de pago consolidadas</h2>
              <ConsolidatedPromisesReport 
                logs={logs} 
                period={period}
                dateRange={dateRange}
                clients={clients}
